...
const units = [
    ...
    { value: "millijoule", label: "Millijoule" },
    { value: "kilojoule", label: "Kilojoule" },
    { value: "megajoule", label: "Megajoule" },
    { value: "calorie", label: "Calorie" },
    { value: "kilocalorie", label: "Kilocalorie" },
    { value: "watt second", label: "Watt Second" },
    { value: "watt hour", label: "Watt Hour" },
...
export default function EnergyConverter() {
  ...
  useEffect(() => {
    ...
    if (!isNaN(num)) {
      const result = convertUnit(num, 'energy', fromUnit, toUnit);
